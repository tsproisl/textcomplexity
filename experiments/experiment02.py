...
def main():
    ...
    for idx, text in metadata.iterrows():
        ...
        add, add_stdev = syntactic_complexity.average_dependency_distance(sentence_graphs)
        cc, cc_stdev = syntactic_complexity.closeness_centrality(sentence_graphs)
        odc, odc_stdev = syntactic_complexity.outdegree_centralization(sentence_graphs)
        ccentr, ccentr_stdev = syntactic_complexity.closeness_centralization(sentence_graphs)
        asl, asl_stdev = syntactic_complexity.average_sentence_length(sentence_graphs)
        dpw, dpw_stdev = syntactic_complexity.dependents_per_word(sentence_graphs)
        lsp, lsp_stdev = syntactic_complexity.longest_shortest_path(sentence_graphs)
